     ...
     <ul>
      ...
      <li class="mb-4">
       <div>
        ...
        <ul class="pl-8 mt-2" id="disburseDropdown">
         <li class="mb-2">
          <a class="text-blue-700 font-bold" href="DPayoutApproval.php">
           Payout Approval
          </a>
         </li>
         <li class="mb-2">
...
<li class="mb-4">
  ...
  <div class="header">
    ...
    <button class="btn-add">Add Payout Request</button>
  </div>
    ...
    <tbody>
      <tr>
        ...
        <td>
          ...
          <button class="action-button approved-button">Approved</button>
        </td>
      </tr>
      <tr>
        <td>2</td>
